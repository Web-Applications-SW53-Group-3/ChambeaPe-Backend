...
namespace _3._Data.Migrations
{
    ...
    [Migration("20231025045413_AddUserDescription")]
            ...
            modelBuilder.Entity("_3._Data.Model.Advertisement", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2023, 10, 24, 23, 54, 11, 707, DateTimeKind.Local).AddTicks(8680))
            ...
            modelBuilder.Entity("_3._Data.Model.Chat", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 24, 23, 54, 11, 708, DateTimeKind.Local).AddTicks(6082))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Claim", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 24, 23, 54, 11, 709, DateTimeKind.Local).AddTicks(1910))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Contract", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 24, 23, 54, 11, 709, DateTimeKind.Local).AddTicks(6271))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Employer", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 24, 23, 54, 11, 710, DateTimeKind.Local).AddTicks(662))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Evidence", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 24, 23, 54, 11, 710, DateTimeKind.Local).AddTicks(3738))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Message", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 24, 23, 54, 11, 710, DateTimeKind.Local).AddTicks(6364))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Notification", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 24, 23, 54, 11, 710, DateTimeKind.Local).AddTicks(8129))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Portfolio", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 24, 23, 54, 11, 710, DateTimeKind.Local).AddTicks(9874))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Post", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 24, 23, 54, 11, 711, DateTimeKind.Local).AddTicks(2782))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Premium", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 24, 23, 54, 11, 711, DateTimeKind.Local).AddTicks(5544))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Review", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 24, 23, 54, 11, 711, DateTimeKind.Local).AddTicks(7951))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Service", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 24, 23, 54, 11, 712, DateTimeKind.Local).AddTicks(2261))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Skill", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 24, 23, 54, 11, 712, DateTimeKind.Local).AddTicks(5273))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Suscription", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 24, 23, 54, 11, 712, DateTimeKind.Local).AddTicks(8515))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 24, 23, 54, 11, 713, DateTimeKind.Local).AddTicks(2390))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.UserNotification", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 24, 23, 54, 11, 713, DateTimeKind.Local).AddTicks(5164))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Worker", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 24, 23, 54, 11, 713, DateTimeKind.Local).AddTicks(9375))
                        .HasColumnName("Date_created");
