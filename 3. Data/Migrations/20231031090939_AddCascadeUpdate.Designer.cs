...
namespace _3._Data.Migrations
{
    ...
    [Migration("20231031090939_AddCascadeUpdate")]
    partial class AddCascadeUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("_3._Data.Model.Advertisement", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2023, 10, 31, 4, 9, 38, 250, DateTimeKind.Local).AddTicks(410))
            ...
            modelBuilder.Entity("_3._Data.Model.Chat", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 31, 4, 9, 38, 250, DateTimeKind.Local).AddTicks(7723))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Claim", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 31, 4, 9, 38, 251, DateTimeKind.Local).AddTicks(3403))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Contract", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 31, 4, 9, 38, 251, DateTimeKind.Local).AddTicks(7667))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Employer", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 31, 4, 9, 38, 252, DateTimeKind.Local).AddTicks(1751))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Evidence", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 31, 4, 9, 38, 252, DateTimeKind.Local).AddTicks(4638))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Message", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 31, 4, 9, 38, 252, DateTimeKind.Local).AddTicks(7078))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Notification", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 31, 4, 9, 38, 252, DateTimeKind.Local).AddTicks(8529))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Portfolio", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 31, 4, 9, 38, 253, DateTimeKind.Local).AddTicks(128))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Post", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 31, 4, 9, 38, 253, DateTimeKind.Local).AddTicks(2951))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Premium", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 31, 4, 9, 38, 253, DateTimeKind.Local).AddTicks(5493))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Review", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 31, 4, 9, 38, 253, DateTimeKind.Local).AddTicks(7630))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Service", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 31, 4, 9, 38, 254, DateTimeKind.Local).AddTicks(1670))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Skill", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 31, 4, 9, 38, 254, DateTimeKind.Local).AddTicks(4514))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Suscription", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 31, 4, 9, 38, 254, DateTimeKind.Local).AddTicks(7681))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 31, 4, 9, 38, 255, DateTimeKind.Local).AddTicks(1374))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.UserNotification", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 31, 4, 9, 38, 255, DateTimeKind.Local).AddTicks(4107))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Worker", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 10, 31, 4, 9, 38, 255, DateTimeKind.Local).AddTicks(7889))
                        .HasColumnName("Date_created");
