...
namespace _3._Data.Migrations
{
    ...
    [Migration("20231121195354_PostulationTesting")]
    partial class PostulationTesting
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("_3._Data.Model.Advertisement", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        ...
                        .HasDefaultValue(new DateTime(2023, 11, 21, 14, 53, 52, 620, DateTimeKind.Local).AddTicks(6845))
            ...
            modelBuilder.Entity("_3._Data.Model.Chat", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 11, 21, 14, 53, 52, 621, DateTimeKind.Local).AddTicks(5356))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Claim", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 11, 21, 14, 53, 52, 622, DateTimeKind.Local).AddTicks(1450))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Contract", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 11, 21, 14, 53, 52, 622, DateTimeKind.Local).AddTicks(6144))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Employer", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 11, 21, 14, 53, 52, 623, DateTimeKind.Local).AddTicks(562))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Evidence", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 11, 21, 14, 53, 52, 623, DateTimeKind.Local).AddTicks(3720))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Message", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 11, 21, 14, 53, 52, 623, DateTimeKind.Local).AddTicks(6190))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Notification", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 11, 21, 14, 53, 52, 623, DateTimeKind.Local).AddTicks(7772))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Portfolio", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 11, 21, 14, 53, 52, 623, DateTimeKind.Local).AddTicks(9508))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Post", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 11, 21, 14, 53, 52, 624, DateTimeKind.Local).AddTicks(2560))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Premium", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 11, 21, 14, 53, 52, 624, DateTimeKind.Local).AddTicks(5346))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Review", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 11, 21, 14, 53, 52, 624, DateTimeKind.Local).AddTicks(7768))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Service", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 11, 21, 14, 53, 52, 625, DateTimeKind.Local).AddTicks(2042))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Skill", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 11, 21, 14, 53, 52, 625, DateTimeKind.Local).AddTicks(5063))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Suscription", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 11, 21, 14, 53, 52, 625, DateTimeKind.Local).AddTicks(8636))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.User", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 11, 21, 14, 53, 52, 626, DateTimeKind.Local).AddTicks(2593))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.UserNotification", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 11, 21, 14, 53, 52, 626, DateTimeKind.Local).AddTicks(5488))
                        .HasColumnName("Date_created");
            ...
            modelBuilder.Entity("_3._Data.Model.Worker", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValue(new DateTime(2023, 11, 21, 14, 53, 52, 626, DateTimeKind.Local).AddTicks(9620))
                        .HasColumnName("Date_created");
